...
<html lang="en">
    ...
    <body class="block code-block relative" ng-app="audio">
        ...
        <div class="site-content w100 relative z2 trailing4">
                ...
                <div class="box is-relative z1 m-buff-right m-buff-left t-buff-right t-buff-left">
                    <div class="line no-margin">
                        ...
                        <div class="w100" ng-controller="audiolist-ctrl">
                            ...
                            <div class="audio-wrapper w50 m-w100 trailing07" ng-repeat="(key,val) in audioList" ng-class-odd="'st-buff-right sdl-buff-right'" ng-class-even="'st-buff-left sdl-buff-left'" ng-mouseup="deactivatePlayhead(val.id, $event)">
